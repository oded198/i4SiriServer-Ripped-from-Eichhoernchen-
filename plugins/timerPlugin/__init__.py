...
class timerPlugin(Plugin):
    ...
    localizations = {
        'Timer': {
            'durationTooBig': {
                ...
                'en-AU': u'I\u2019ve canceled the timer.',
                'en-GB': u'I\u2019ve canceled the timer.',
                'fr-FR': u'J\'ai remis à zéro le minuteur.'
            }, 'timerWasResumed': {
                'en-US': u'It\u2019s resumed.',
                'en-AU': u'It\u2019s resumed.',
                'en-GB': u'It\u2019s resumed.',
                'fr-FR': u'C\'est reparti.'
            }, "timerWasSet": {
                "en-US": "Your timer is set for {0}.",
                "en-AU": "Your timer is set for {0}.",
                "en-GB": "Your timer is set for {0}.",
    ...
    res = {
        'articles': {
            ...
            'en-AU': '.*(pause|freeze|hold).*timer',
            'en-GB': '.*(pause|freeze|hold).*timer',
            'fr-FR': u'.*(pause|pose|suspend|interromp).*minuteur'
        }, 'resetTimer': {
            'en-US': '.*(cancel|reset|stop).*timer',
            'en-AU': '.*(cancel|reset|stop).*timer',
            'en-GB': '.*(cancel|reset|stop).*timer',
            'fr-FR': u'.*(annule|reset|arret|arrêt|zero|zéro|stop).*minuteur'
        }, 'resumeTimer': {
            'en-US': '.*(resume|thaw|continue).*timer',
            'en-AU': '.*(resume|thaw|continue).*timer',
            'en-GB': '.*(resume|thaw|continue).*timer',
            ...
            'en-AU': '.*timer[^0-9]*(?P<length>([0-9/ ]|seconds?|secs?|minutes?|mins?|hours?|hrs?|and|the|an|a){2,})',
            'en-GB': '.*timer[^0-9]*(?P<length>([0-9/ ]|seconds?|secs?|minutes?|mins?|hours?|hrs?|and|the|an|a){2,})',
            'fr-FR': '.*minuteur[^0-9]*(?P<length>([0-9/ ]|secondes?|secs?|minutes?|mins?|heures?|hrs?|et){2,})'
        }, 'showTimer': {
            'en-US': '.*(show|display|see).*timer',
            'en-AU': '.*(show|display|see).*timer',
            'en-GB': '.*(show|display|see).*timer',
            'fr-FR': u'.*(montre|affiche|voir).*minuteur'
        }, 'timerLength': {
            'en-US': '([0-9][0-9 /]*|an|a|the)\s+(seconds?|secs?|minutes?|mins?|hours?|hrs?)',
            'en-AU': '([0-9][0-9 /]*|an|a|the)\s+(seconds?|secs?|minutes?|mins?|hours?|hrs?)',
            'en-AU': '([0-9][0-9 /]*|an|a|the)\s+(seconds?|secs?|minutes?|mins?|hours?|hrs?)',
    ...
    @register("en-AU", res['setTimer']['en-AU'])
    @register("en-GB", res['setTimer']['en-GB'])
	...
	@register("en-AU", res['resetTimer']['en-AU'])
	@register("en-GB", res['resetTimer']['en-GB'])
    ...
    @register("en-AU", res['resumeTimer']['en-AU'])
    @register("en-GB", res['resumeTimer']['en-GB'])
    ...
    @register("en-AU", res['pauseTimer']['en-AU'])
    @register("en-GB", res['pauseTimer']['en-GB'])
    ...
    @register("en-AU", res['showTimer']['en-AU'])
    @register("en-GB", res['showTimer']['en-GB'])
