...
class timePlugin(Plugin):
    ...
    localizations = {"currentTime": 
                        {"search":{"de-DE": "Es wird gesucht ...", "en-US": "Looking up ...","en-AU": "Looking up ...","en-GB": "Looking up ...", "fr-FR": u"Je cherche ..."}, 
                         "currentTime": {"de-DE": "Es ist @{fn#currentTime}", "en-US": "It is @{fn#currentTime}","en-AU": "It is @{fn#currentTime}","en-GB": "It is @{fn#currentTime}", "fr-FR": u"Il est @{fn#currentTime}"}}, 
                     "currentTimeIn": 
                        {"search":{"de-DE": "Es wird gesucht ...", "en-US": "Looking up ...", "fr-FR": "Je cherche ..."}, 
                         "currentTimeIn": 
                                {
                                "tts": {"de-DE": u"Die Uhrzeit in {0},{1} ist @{{fn#currentTimeIn#{2}}}:", "en-US": "The time in {0},{1} is @{{fn#currentTimeIn#{2}}}:","en-AU": "The time in {0},{1} is @{{fn#currentTimeIn#{2}}}:","en-GB": "The time in {0},{1} is @{{fn#currentTimeIn#{2}}}:", "fr-FR": u"Il est  @{{fn#currentTimeIn#{2}}} à {0}, {1}"},
                                "text": {"de-DE": u"Die Uhrzeit in {0}, {1} ist @{{fn#currentTimeIn#{2}}}:", "en-US": "The time in {0}, {1} is @{{fn#currentTimeIn#{2}}}:","en-AU": "The time in {0}, {1} is @{{fn#currentTimeIn#{2}}}:","en-GB": "The time in {0}, {1} is @{{fn#currentTimeIn#{2}}}:", "fr-FR": u"Il est  @{{fn#currentTimeIn#{2}}} à {0}, {1}"}
                                }
                        },
                    "failure": {
                                "de-DE": "Ich kann dir die Uhr gerade nicht anzeigen!", "en-US": "I cannot show you the clock right now","en-AU": "I cannot show you the clock right now","en-GB": "I cannot show you the clock right now", "fr-FR": u"Désolé, j'ai perdu ma montre."
                                }
                    }

    @register("de-DE", "(Wie ?viel Uhr.*)|(.*Uhrzeit.*)")     
    @register("en-US", "(What.*time.*)|(.*current time.*)")
    @register("en-AU", "(What.*time.*)|(.*current time.*)")
    ...
    @register("en-AU", "(What.*time.*in ([\w ]+))|(.*current time.*in ([\w ]+))")
