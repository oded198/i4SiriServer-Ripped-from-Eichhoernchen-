...
from siriObjects.textObjects import Text, TextSnippet
import re
import random
...
'notFound': 
    {'de-DE': u"Entschuldigung, ich konnte niemanden in deinem Telefonbuch finden der so heißt",
     ...
     'en-AU': u"Sorry, I did not find a match in your phone book",
...
'devel':
    {'de-DE': u"Entschuldigung, aber diese Funktion befindet sich noch in der Entwicklungsphase",
     ...
     'en-AU': u"Sorry this feature is still under development",
...
'callPerson': 
    {'de-DE': u"Rufe {0}, {1} an: {2}",
     ...
     'en-AU': u"Calling {0}, {1}: {2}",
     'fr-FR': u"Appel de {0}, {1}: {2}"
    }
}

numberTypesLocalized= {
'_$!<Mobile>!$_': {'en-US': u"mobile",'en-AU': u"mobile",'en-GB': u"mobile", 'de-DE': u"Handynummer", 'fr-FR': u"mobile"},
'iPhone': {'en-US': u"iPhone",'en-AU': u"iPhone",'en-GB': u"iPhone", 'de-DE': u"iPhone-Nummer", 'fr-FR': u"iPhone"},
'_$!<Home>!$_': {'en-US': u"home",'en-AU': u"home",'en-GB': u"home", 'de-DE': u"Privatnummer", 'fr-FR': u"domicile"},
'_$!<Work>!$_': {'en-US': u"work",'en-AU': u"work",'en-GB': u"work", 'de-DE': u"Geschäftsnummer", 'fr-FR': u"bureau"},
'_$!<Main>!$_': {'en-US': u"main",'en-AU': u"main",'en-GB': u"main", 'de-DE': u"Hauptnummer",'fr-FR': u"principal"},
'_$!<HomeFAX>!$_': {'en-US': u"home fax",'en-AU': u"home fax",'en-GB': u"home fax", 'de-DE': u'private Faxnummer', 'fr-FR': u'fax domicile'},
'_$!<WorkFAX>!$_': {'en-US': u"work fax",'en-AU': u"work fax",'en-GB': u"work fax", 'de-DE': u"geschäftliche Faxnummer", 'fr-FR': u"fax bureau"},
'_$!<OtherFAX>!$_': {'en-US': u"_$!<OtherFAX>!$_",'en-AU': u"_$!<OtherFAX>!$_",'en-GB': u"_$!<OtherFAX>!$_", 'de-DE': u"_$!<OtherFAX>!$_", 'fr-FR': u"_$!<OtherFAX>!$_"},
'_$!<Pager>!$_': {'en-US': u"pager",'en-AU': u"pager",'en-GB': u"pager", 'de-DE': u"Pagernummer", 'fr-FR': u"biper"},
'_$!<Other>!$_':{'en-US': u"other phone",'en-AU': u"other phone",'en-GB': u"other phone", 'de-DE': u"anderes Telefon", 'fr-FR': u"autre"}
}
...
'en-AU': {'work': "_$!<Work>!$_",'home': "_$!<Home>!$_", 'mobile': "_$!<Mobile>!$_"},
...
'en-AU': u"Sorry, I did not understand, please try again.",
...
class textmessagePlugin(Plugin):
    ...
    @register("en-US", "(make a )?text (to )?(?P<name>[\w ]+).*(?P<type>work|home|mobile|main|iPhone|pager)?")
    @register("en-AU", "(make a )?text (to )?(?P<name>[\w ]+).*(?P<type>work|home|mobile|main|iPhone|pager)?")
    @register("en-GB", "(make a )?text (to )?(?P<name>[\w ]+).*(?P<type>work|home|mobile|main|iPhone|pager)?")
