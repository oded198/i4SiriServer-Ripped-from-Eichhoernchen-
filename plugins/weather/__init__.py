...
class weatherPlugin(Plugin):
    localizations = {"weatherForecast": 
                        {"search":{
                            0:{"de-DE": u"Einen Moment Geduld bitte...", "en-US": "Checking my sources...","en-AU": "Checking my sources...","en-GB": "Checking my sources...", "fr-FR": u"Je vérifie mes sources..."},
                            1:{"de-DE": u"Ich suche nach der Vorhersage ...", "en-US": "Please wait while I check that...","en-AU": "Please wait while I check that...","en-GB": "Please wait while I check that...", "fr-FR": "Je regarde..."},
                            2:{"de-DE": u"Einen Moment bitte ...", "en-US": "One moment please...","en-AU": "One moment please...","en-GB": "One moment please...", "fr-FR":"Un instant..."},
                            3:{"de-DE": u"Ich suche nach Wetterdaten...", "en-US": "Trying to get weather data for this location...","en-AU": "Trying to get weather data for this location...","en-GB": "Trying to get weather data for this location...","fr-FR": u"Je récupère la météo de cet endroit..."},
                            }, 
                        "forecast":{
                            "DAILY": {
                                0:{"de-DE": u"Hier ist die Vorhersage für {0}, {1}", "en-US": u"Here is the forecast for {0}, {1}","en-AU": u"Here is the forecast for {0}, {1}","en-GB": u"Here is the forecast for {0}, {1}", "fr-FR": u"Voici les prévisions pour {0}, {1}"},
                                1:{"de-DE": u"Hier ist die Wetterprognose für {0}, {1}", "en-US": u"Here is the forecast for {0}, {1}","en-AU": u"Here is the forecast for {0}, {1}","en-GB": u"Here is the forecast for {0}, {1}", "fr-FR": u"Voilà les prévisions pour {0}, {1}"},
                                2:{"de-DE": u"Ich habe folgende Vorhersage für {0}, {1} gefunden", "en-US": u"I found the following forecast for {0}, {1}","en-AU": u"I found the following forecast for {0}, {1}","en-GB": u"I found the following forecast for {0}, {1}", "fr-FR": u"J'ai trouvé les prévisions suivantes pour {0}, {1}."},
                                },
                            "HOURLY": {
                                0:{"de-DE": u"Hier ist die heutige Vorhersage für {0}, {1}", "en-US": u"Here is today's forecast for {0}, {1}","en-AU": u"Here is today's forecast for {0}, {1}","en-GB": u"Here is today's forecast for {0}, {1}","fr-FR": u"Voici les prévisions d'aujourd'hui pour {0}, {1}."},
                                1:{"de-DE": u"Hier ist die Wetterprognose von heute für {0}, {1}", "en-US": u"This is today's forecast for {0}, {1}","en-AU": u"This is today's forecast for {0}, {1}","en-GB": u"This is today's forecast for {0}, {1}", "fr-FR": u"Voici les prévisions d'aujourd'hui pour {0}, {1}."},
                                2:{"de-DE": u"Ich habe folgende Tagesprognose für {0}, {1} gefunden", "en-US": u"I found the following hourly forecast for {0}, {1}","en-AU": u"I found the following hourly forecast for {0}, {1}","en-GB": u"I found the following hourly forecast for {0}, {1}","fr-FR": u"J'ai trouvé les prévisions pour {0}, {1}."},
                                }
                        },
                        "failure": {
                                   "de-DE": "Ich konnte leider keine Wettervorhersage finden!", "en-US": "I'm sorry but I could not find the forecast for this location!","en-AU": "I'm sorry but I could not find the forecast for this location!","en-GB": "I'm sorry but I could not find the forecast for this location!","fr-FR": u"Je suis désolé, je ne trouve pas cet endroit !"
                                   }
                        }
                    }
    
    @register("de-DE", "(.*Wetter.*)|(.*Vorhersage.*)")     
    @register("en-US", ".*(Temp|weather|forecast|need.*umbrella|rain.*today|cold.*outside|hot.*outside|sunny.*outside.*).*")
    @register("en-GB", ".*(Temp|weather|forecast|need.*umbrella|rain.*today|cold.*outside|hot.*outside|sunny.*outside.*).*")
    @register("en-AU", ".*(Temp|weather|forecast|need.*umbrella|rain.*today|cold.*outside|hot.*outside|sunny.*outside.*).*")
