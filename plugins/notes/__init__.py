...
class note(Plugin):
    localizations = {"noteDefaults": 
                        {"searching":{"en-US": "Creating your note ...","en-AU": "Creating your note ...","en-GB": "Creating your note ...","fr-FR": u"Création de votre note..."}, 
                         "result": {"en-US": "Here is your note:","en-AU": "Here is your note:","en-GB": "Here is your note:","fr-FR": "Voici votre note :"},
                         "nothing": {"en-US": "What should I note?","en-AU": "What should I note?","en-GB": "What should I note?","fr-FR": "Que dois-je noter ?"}}, 
                    "failure": {
                                "en-US": "I cannot type your note right now.",
                                "en-AU": "I cannot type your note right now.",
                                "en-GB": "I cannot type your note right now.",
    ...
    @register("en-AU", "(.*note [a-zA-Z0-9]+)|(.*create.*note [a-zA-Z0-9]+)|(.*write.*note [a-zA-Z0-9]+)")
    @register("en-GB", "(.*note [a-zA-Z0-9]+)|(.*create.*note [a-zA-Z0-9]+)|(.*write.*note [a-zA-Z0-9]+)")
