...
class alarmPlugin(Plugin):
    localizations = {
        'Alarm': {
            "settingAlarm": {
                ...
                "en-AU": u"Setting the Alarm\u2026",
                "en-GB": u"Setting the Alarm\u2026",
                "fr-FR": u"Réglage de l'alarme\u2026"
            }, "alarmWasSet": {
                "en-US": "Your alarm is set for {0}:{1} {2}.",
                "en-AU": "Your alarm is set for {0}:{1} {2}.",
                "en-GB": "Your alarm is set for {0}:{1} {2}.",
                "fr-FR": u"Votre alarme est programmée pour {0}:{1} {2}"
            }, "alarmSetWithLabel": {
                "en-US": "Your alarm {0} {1} is set for {2}:{3} {4}.",
                "en-AU": "Your alarm {0} {1} is set for {2}:{3} {4}.",
                "en-GB": "Your alarm {0} {1} is set for {2}:{3} {4}.",
    ...
    res = {
        'setAlarm': {
            ...
            'en-AU': '.*set.* alarm for.* (0?[1-9]|1[012])([0-5]\d)?\s?([APap][mM])\s?(\bcalled|named|labeled\b)?\s?(([a-z0-9]{1,7}\s)?([a-z0-9]{1,7})\s?([a-z0-9]{1,7}))?',
            'en-GB': '.*set.* alarm for.* (0?[1-9]|1[012])([0-5]\d)?\s?([APap][mM])\s?(\bcalled|named|labeled\b)?\s?(([a-z0-9]{1,7}\s)?([a-z0-9]{1,7})\s?([a-z0-9]{1,7}))?',
    ...
    @register("en-AU", res['setAlarm']['en-AU'])
    @register("en-GB", res['setAlarm']['en-GB'])
